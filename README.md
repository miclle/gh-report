...
- **AI 日报生成** — 通过 AI API（支持 Anthropic Claude 和 OpenAI）将活动数据自动整理为工作日报
...
# 是否调用 AI API 直接生成日报（需配合 format: summary 使用）
# ai: true
...
通过 AI API 直接生成工作日报（支持 Anthropic Claude 和 OpenAI）：
